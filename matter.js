				...
				function(e, t, n) {
					...
					!(function() {
						...
						var e = function(e, t) {
							...
							var n = e.isStatic
								? '#2e2b44'
								: a.choose([ '#006BA6', '#0496FF', '#FFBC42', '#D81159', '#8F2D56' ]);
						...
						(o.set = function(e, t, n) {
							...
							(o.setParts = function(e, t, n) {
								var r;
								for (
									t = t.slice(0), e.parts.length = 0, e.parts.push(e), e.parent = e, r = 0;
									r < t.length;
									r++
								) {
									var s = t[r];
							...
							(o.rotate = function(e, t, n) {
								if (n) {
									var i = Math.cos(t),
										...
										s = e.position.x - n.x,
										a = e.position.y - n.y;
									o.setPosition(e, { x: n.x + (s * i - a * r), y: n.y + (s * r + a * i) }),
							...
							(o.scale = function(e, t, n, r) {
								...
								for (var d = 0; d < e.parts.length; d++) {
									...
									i.scale(u.vertices, t, n, r),
										...
										i.translate(u.vertices, { x: -u.position.x, y: -u.position.y }),
										o.setInertia(u, o._inertiaScale * i.inertia(u.vertices, u.mass)),
										i.translate(u.vertices, { x: u.position.x, y: u.position.y }),
								...
								e.parts.length > 1 &&
									((e.area = s), e.isStatic || (o.setMass(e, e.density * s), o.setInertia(e, a))),
								...
								for (var p = 0; p < e.parts.length; p++) {
									...
									i.translate(f.vertices, e.velocity),
										...
										0 !== e.angularVelocity &&
											...
											p > 0 &&
												r.rotateAbout(f.position, e.angularVelocity, e.position, f.position)),
				...
				function(e, t, n) {
					...
					!(function() {
						(o.create = function(e) {
							...
							(o.rebase = function(e) {
								for (
									var t = o.allBodies(e).concat(o.allConstraints(e)).concat(o.allComposites(e)),
										n = 0;
									n < t.length;
									n++
								)
							...
							(o.rotate = function(e, t, n, i) {
								for (
									var r = Math.cos(t), s = Math.sin(t), l = i ? o.allBodies(e) : e.bodies, c = 0;
									c < l.length;
									c++
								) {
									var d = l[c],
										u = d.position.x - n.x,
										p = d.position.y - n.y;
									a.setPosition(d, { x: n.x + (u * r - p * s), y: n.y + (u * s + p * r) }),
										a.rotate(d, t);
								}
								return o.setModified(e, !0, !0, !1), e;
							}),
						...
						o.create = function(e) {
							var t = i.create(),
								n = {
									...
									bounds: { min: { x: -1 / 0, y: -1 / 0 }, max: { x: 1 / 0, y: 1 / 0 } }
								};
						...
						(o.collisions = function(e, t) {
							for (var n = [], a = t.pairs.table, l = 0; l < e.length; l++) {
								var c = e[l][0],
									d = e[l][1];
								if (
									((!c.isStatic && !c.isSleeping) || (!d.isStatic && !d.isSleeping)) &&
								...
								for (u.length = 0, p.length = 0, f.length = 0, l = 0; l < t.length; l++)
									(o = t[l]),
										o.collided &&
											...
											(a = d[s]),
											a
												? (a.isActive ? f.push(a) : u.push(a), i.update(a, o, n))
												: ((a = i.create(o, n)), (d[s] = a), u.push(a), c.push(a)));
								for (l = 0; l < c.length; l++)
									(a = c[l]),
										a.isActive && -1 === r.indexOf(m, a.id) && (i.setActive(a, !1, n), p.push(a));
							}),
						...
						(o._restingThresh = 4),
									...
									(i = e[n]),
										i.isActive &&
											...
											(d = r.sub(
												...
												r.add(a.positionImpulse, r.sub(l.position, s.penetration, m), v),
												y
											)),
							...
							(o.postSolvePosition = function(e) {
								for (var t = 0; t < e.length; t++) {
									var n = e[t];
									if (
										((n.totalContacts = 0), 0 !== n.positionImpulse.x || 0 !== n.positionImpulse.y)
									) {
					...
					!(function() {
						(o.collides = function(e, t, n) {
							...
							(o._overlapAxes = function(e, t, n) {
								for (
									var i, s, a = r._temp[0], l = r._temp[1], c = { overlap: Number.MAX_VALUE }, d = 0;
									d < n.length;
									d++
								) {
									if (
							...
							(o.preSolveAll = function(e) {
								for (var t = 0; t < e.length; t += 1) {
									...
									n.isStatic ||
										...
										((n.position.x += o.x), (n.position.y += o.y), (n.angle += o.angle));
								}
							}),
							...
							(o.solve = function(e, t) {
								...
								if (n || i) {
									n && !n.isStatic && (r.rotate(s, n.angle - e.angleA, s), (e.angleA = n.angle)),
										i && !i.isStatic && (r.rotate(a, i.angle - e.angleB, a), (e.angleB = i.angle));
									var l = s,
										c = a;
										...
										for (var d = 0; d < n.parts.length; d++) {
											...
											i.translate(u.vertices, c),
												...
												0 !== c.angle &&
													...
													d > 0 &&
														r.rotateAbout(u.position, c.angle, n.position, u.position)),
							...
							(function() {
								(o._nextId = 0),
									...
									(o.random = function(e, n) {
										return (
											(e = void 0 !== e ? e : 0), (n = void 0 !== n ? n : 1), e + t() * (n - e)
										);
									});
								var t = function() {
								...
								(o.colorToNumber = function(e) {
									...
									(o.chain = function() {
										...
										var o = function() {
											for (
												var t, n = new Array(arguments.length), o = 0, i = arguments.length;
												o < i;
												o++
											)
												n[o] = arguments[o];
									...
									(o._requireGlobal = function(t, o) {
										return (
											('undefined' != typeof window ? window[t] : void 0 !== n ? n[t] : null) ||
											e(o)
										);
									});
							})();
					...
					!(function() {
						(o.create = function(e, t) {
							(t = f.isElement(e) ? t : e),
								...
								(t = t || {}),
								(e || t.render) && f.warn('Engine.create: engine.render is deprecated (see docs)');
							var n = {
							...
							return (
								o.render && o.render.controller && (o.render = o.render.controller.create(o.render)),
							...
							(o.update = function(e, t, n) {
								...
								for (
									l.update(h, x, b),
										...
										h.collisionStart.length > 0 &&
											d.trigger(e, 'collisionStart', { pairs: h.collisionStart }),
								...
								return (
									h.collisionActive.length > 0 &&
										d.trigger(e, 'collisionActive', { pairs: h.collisionActive }),
					...
					!(function() {
						(o.create = function(e) {
							...
							(o._getRelativeMousePosition = function(e, t, n) {
								...
								return (
									c
										? ((o = c[0].pageX - r.left - a), (i = c[0].pageY - r.top - l))
						...
						(o._registry = {}),
							(o.register = function(e) {
								if (
									...
									n > r
										? (i.warn('Plugin.register:', o.toString(t), 'was upgraded to', o.toString(e)),
							...
							(o.use = function(e, t) {
								...
								for (
									var n = o.dependencies(e), r = i.topologicalSort(n), s = [], a = 0;
									a < r.length;
									a += 1
								)
									if (r[a] !== e.name) {
								...
								if (i.isString(e)) {
									return (
										/^[\w-]+(@(\*|[\^~]?\d+\.\d+\.\d+(-[0-9A-Za-z-]+)?))?$/.test(e) ||
											i.warn('Plugin.dependencyParse:', e, 'is not a valid dependency string.'),
							...
							(o.versionParse = function(e) {
								/^\*|[\^~]?\d+\.\d+\.\d+(-[0-9A-Za-z-]+)?$/.test(e) ||
									i.warn('Plugin.versionParse:', e, 'is not a valid version or range.');
								var t = e.split('-');
								e = t[0];
				...
				function(e, t, n) {
					...
					!(function() {
						...
						(o.create = function(e) {
							...
							(o.run = function(t, n) {
								return (
									void 0 !== t.positionIterations && ((n = t), (t = o.create())),
									(function i(r) {
						...
						(o._motionWakeThreshold = 0.18),
								...
								for (var n = t * t * t, i = 0; i < e.length; i++) {
									...
									if (0 === r.force.x && 0 === r.force.y) {
										...
										(r.motion = o._minBias * a + (1 - o._minBias) * l),
											r.sleepThreshold > 0 && r.motion < o._motionSleepThreshold * n
												? ((r.sleepCounter += 1),
								...
								for (var n = t * t * t, i = 0; i < e.length; i++) {
									...
									if (r.isActive) {
										var s = r.collision,
											...
											l = s.bodyB.parent;
										if (
											!((a.isSleeping && l.isSleeping) || a.isStatic || l.isStatic) &&
							...
							(o.set = function(e, t) {
								...
								t
									...
									: ((e.isSleeping = !1), (e.sleepCounter = 0), n && i.trigger(e, 'sleepEnd'));
							});
					})();
				},
				{
				...
				function(e, t, n) {
					...
					!(function() {
						(o.rectangle = function(e, t, n, o, i) {
							...
							if (i.chamfer) {
								var c = i.chamfer;
								(l.vertices = r.chamfer(l.vertices, c.radius, c.quality, c.qualityMin, c.qualityMax)),
									delete i.chamfer;
							}
							...
							(o.trapezoid = function(e, t, n, o, i, l) {
								...
								c =
									i < 0.5
										? 'L 0 0 L ' + u + ' ' + -o + ' L ' + p + ' ' + -o + ' L ' + f + ' 0'
										: 'L 0 0 L ' + p + ' ' + -o + ' L ' + f + ' 0';
								var m = { label: 'Trapezoid Body', position: { x: e, y: t }, vertices: r.fromPath(c) };
								if (l.chamfer) {
									var v = l.chamfer;
							...
							(o.polygon = function(e, t, n, i, l) {
								...
								for (var c = 2 * Math.PI / n, d = '', u = 0.5 * c, p = 0; p < n; p += 1) {
									var f = u + p * c,
										m = Math.cos(f) * i,
										v = Math.sin(f) * i;
									d += 'L ' + m.toFixed(3) + ' ' + v.toFixed(3) + ' ';
								}
								var y = { label: 'Polygon Body', position: { x: e, y: t }, vertices: r.fromPath(d) };
								if (l.chamfer) {
									var g = l.chamfer;
						...
						(o.stack = function(e, t, n, o, r, s, l) {
							...
							(o.mesh = function(e, t, n, o, a) {
								...
								for (l = 0; l < n; l++) {
									for (c = 1; c < t; c++)
										(d = f[c - 1 + l * t]),
											(u = f[c + l * t]),
											i.addConstraint(e, r.create(s.extend({ bodyA: d, bodyB: u }, a)));
									if (l > 0)
										for (c = 0; c < t; c++)
											(d = f[c + (l - 1) * t]),
												(u = f[c + l * t]),
												...
												o &&
													c > 0 &&
													((p = f[c - 1 + (l - 1) * t]),
													i.addConstraint(e, r.create(s.extend({ bodyA: p, bodyB: u }, a)))),
												o &&
													c < t - 1 &&
													((p = f[c + 1 + (l - 1) * t]),
													i.addConstraint(e, r.create(s.extend({ bodyA: p, bodyB: u }, a))));
							...
							(o.newtonsCradle = function(e, t, n, o, s) {
								for (var a = i.create({ label: 'Newtons Cradle' }), c = 0; c < n; c++) {
									var d = l.circle(e + c * (1.9 * o), t + s, o, {
										...
										u = r.create({ pointA: { x: e + c * (1.9 * o), y: t }, bodyB: d });
							...
							(o.car = function(e, t, n, o, s) {
								var c = a.nextGroup(!0),
									...
									m = l.circle(e + d, t + 0, s, { collisionFilter: { group: c }, friction: 0.8 }),
									v = l.circle(e + u, t + 0, s, { collisionFilter: { group: c }, friction: 0.8 }),
									y = r.create({
										bodyB: f,
										pointB: { x: d, y: 0 },
										bodyA: m,
							...
							(o.softBody = function(e, t, n, i, r, a, c, d, u, p) {
								(u = s.extend({ inertia: 1 / 0 }, u)),
									(p = s.extend({ stiffness: 0.2, render: { type: 'line', anchors: !1 } }, p));
					...
					!(function() {
						(o.pathToVertices = function(e, t) {
							'undefined' == typeof window ||
								...
								i.warn('Svg.pathToVertices: SVGPathSeg not defined, a polyfill is required.');
							var n,
								r,
								s,
								a,
							...
							(o._svgPathToAbsolute = function(e) {
								for (
									var t, n, o, i, r, s, a = e.pathSegList, l = 0, c = 0, d = a.numberOfItems, u = 0;
									u < d;
									++u
								) {
									var p = a.getItem(u),
						...
						(o.create = function(e, t) {
							...
							(o.inertia = function(e, t) {
								for (var n, o, r = 0, s = 0, a = e, l = 0; l < a.length; l++)
									(o = (l + 1) % a.length),
										...
										(r += n * (i.dot(a[o], a[o]) + i.dot(a[o], a[l]) + i.dot(a[l], a[l]))),
										(s += n);
								return t / 6 * (r / s);
							}),
							(o.translate = function(e, t, n) {
							...
							(o.hull = function(e) {
								...
								for (
									...
									for (
										t = e[n];
										r.length >= 2 && i.cross3(r[r.length - 2], r[r.length - 1], t) <= 0;
								...
								for (n = e.length - 1; n >= 0; n -= 1) {
									for (
										t = e[n];
										o.length >= 2 && i.cross3(o[o.length - 2], o[o.length - 1], t) <= 0;
					...
					!(function() {
						...
						'undefined' != typeof window &&
							...
							(o.lookAt = function(e, t, n, o) {
								...
								for (
									var r = { min: { x: 1 / 0, y: 1 / 0 }, max: { x: -1 / 0, y: -1 / 0 } }, s = 0;
									s < t.length;
									s += 1
								) {
									var a = t[s],
							...
							(o.world = function(e) {
								...
								if (
									...
									for (t = 0; t < y.length; t++) {
										...
										C && (P = c.add(C.position, S.pointA)),
											...
											P &&
												B &&
												((s.contains(e.bounds, P) || s.contains(e.bounds, B)) && h.push(S));
									}
								...
								!m.wireframes || (n.enableSleeping && m.showSleeping)
									? o.bodies(e, x, p)
									: (m.showConvexHulls && o.bodyConvexHulls(e, x, p), o.bodyWireframes(e, x, p)),
									...
									o.constraints(h, p),
									m.showBroadphase && n.broadphase.controller === l && o.grid(e, n.broadphase, p),
							...
							(o.debug = function(e, t) {
								...
								if (o.timing.timestamp - (e.debugTimestamp || 0) >= 500) {
									var l = '';
									s.timing && (l += 'fps: ' + Math.round(s.timing.fps) + '    '),
										(e.debugString = l),
											...
											if (((i = o.parts[s]), i.render.visible)) {
												if (
													(l.showSleeping && o.isSleeping
														...
														: 1 !== i.render.opacity && (a.globalAlpha = i.render.opacity),
								...
								for (l.beginPath(), r = 0; r < t.length; r++)
									if (((o = t[r]), o.render.visible))
										for (a = o.parts.length > 1 ? 1 : 0; a < o.parts.length; a++) {
											for (
												i = o.parts[a], l.moveTo(i.vertices[0].x, i.vertices[0].y), s = 1;
												s < i.vertices.length;
												s++
											)
									...
									if (((o = t[r]), o.render.visible))
										for (s = 0; s < o.parts.length; s++)
											(i = o.parts[s]),
												...
												a.closePath();
								for (
									l.wireframes ? (a.fillStyle = 'indianred') : (a.fillStyle = 'rgba(0,0,0,0.5)'),
										a.fill(),
										a.beginPath(),
										r = 0;
									r < t.length;
							...
							(o.collisions = function(e, t, n) {
								...
								for (
									l.wireframes ? (a.fillStyle = 'rgba(255,255,255,0.7)') : (a.fillStyle = 'orange'),
										a.fill(),
										a.beginPath(),
										r = 0;
									r < t.length;
									...
									if (((o = t[r]), o.isActive && ((i = o.collision), o.activeContacts.length > 0))) {
										...
										2 === o.activeContacts.length &&
											((u = (o.activeContacts[0].vertex.x + o.activeContacts[1].vertex.x) / 2),
											(p = (o.activeContacts[0].vertex.y + o.activeContacts[1].vertex.y) / 2)),
					...
					!(function() {
						...
						'undefined' != typeof window &&
							...
							(o.create = function(e) {
								...
								return (
									...
									(n.renderer =
										n.renderer ||
										new PIXI.WebGLRenderer(n.options.width, n.options.height, n.pixiOptions)),
								...
								if (d.hasBounds) {
									...
									for (t = 0; t < p.length; t++) {
										...
										b && (S = l.add(b.position, h.pointA)),
											...
											S &&
												C &&
												((i.contains(e.bounds, S) || i.contains(e.bounds, C)) && f.push(h));
									}
									c.scale.set(1 / y, 1 / g),
										c.position.set(-e.bounds.min.x * (1 / y), -e.bounds.min.y * (1 / g));
								} else f = p;
								...
								if (o.visible)
									if (o.sprite && o.sprite.texture) {
										...
										var l = 'b-' + t.id,
											d = e.primitives[l],
											u = e.container;
										d || ((d = e.primitives[l] = c(e, t)), (d.initialAngle = t.angle)),
						...
						var n = function(e, t) {
								var n = t.render,
									...
									r = new PIXI.Sprite(i);
								return (
									(r.anchor.x = t.render.sprite.xOffset), (r.anchor.y = t.render.sprite.yOffset), r
								);
							},
							c = function(e, t) {
								var n,
								...
								for (var p = t.parts.length > 1 ? 1 : 0; p < t.parts.length; p++) {
									...
									r.lineTo(n.vertices[0].x - t.position.x, n.vertices[0].y - t.position.y),
										...
										(i.showAngleIndicator || i.showAxes) &&
											...
											r.lineTo(
												(n.vertices[0].x + n.vertices[n.vertices.length - 1].x) / 2 -
													t.position.x,
												(n.vertices[0].y + n.vertices[n.vertices.length - 1].y) / 2 -
													t.position.y
											),
											r.endFill());
								}
